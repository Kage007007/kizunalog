...
class WordRecordSheet extends StatefulWidget {
  const WordRecordSheet({super.key});

  @override
  State<WordRecordSheet> createState() => _WordRecordSheetState();
}

class _WordRecordSheetState extends State<WordRecordSheet> {
  int _step = 0;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('どんな言葉？', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text('なんて言った？', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
          const SizedBox(height: 6),
          Text('お子さんの言葉をそのまま記録しましょう', style: TextStyle(fontSize: 14, color: Colors.grey.shade500)),
          const SizedBox(height: 16),
          TextField(
        ...
        children: [
          TweenAnimationBuilder<double>(
            ...
            child: Container(
              ...
              child: Icon(Icons.favorite_rounded, color: _category.color, size: 40),
            ),
          ),
          const SizedBox(height: 20),
          const Text('きろくできたよ！', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
          const SizedBox(height: 6),
          Text('大切な思い出をありがとう', style: TextStyle(fontSize: 14, color: Colors.grey.shade500)),
