    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('どんな質問？', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700)),
          const SizedBox(height: 8),
          Text('タイプを選んでください', style: TextStyle(fontSize: 14, color: Colors.grey.shade500)),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text('なんて聞いてきた？', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700)),
          const SizedBox(height: 8),
        ...
        children: [
          TweenAnimationBuilder<double>(
            ...
            child: Container(
              ...
              child: Icon(Icons.lightbulb_rounded, color: _category.color, size: 48),
            ),
          ),
          const SizedBox(height: 24),
